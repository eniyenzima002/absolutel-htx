...
export default function SubmitPage() {
  return (
    ...
    //     copy="This front-end form is styled and ready. Wire it later to Netlify Forms, Formspree, or your own endpoint when you are ready."
    //   >
    //     <form className="grid gap-5 sm:grid-cols-2">
    //       <label className="block">
    //         <span className="mb-2 block text-sm font-semibold text-cocoa">Full Name</span>
    //         <input className="w-full rounded-2xl border border-cocoa/10 bg-white/70 px-4 py-3 outline-none ring-0 placeholder:text-cocoa/40 focus:border-rose" placeholder="Your name" />
    //       </label>
    //       <label className="block">
    //         <span className="mb-2 block text-sm font-semibold text-cocoa">Stage Name</span>
    //         <input className="w-full rounded-2xl border border-cocoa/10 bg-white/70 px-4 py-3 outline-none placeholder:text-cocoa/40 focus:border-rose" placeholder="Stage name" />
    //       </label>
    //       <label className="block">
    ...
    //       </label>
    //       <label className="block">
    //         <span className="mb-2 block text-sm font-semibold text-cocoa">Performance Type</span>
    //         <select className="w-full rounded-2xl border border-cocoa/10 bg-white/70 px-4 py-3 outline-none focus:border-rose">
    ...
    //         <span className="mb-2 block text-sm font-semibold text-cocoa">Links</span>
    //         <input className="w-full rounded-2xl border border-cocoa/10 bg-white/70 px-4 py-3 outline-none placeholder:text-cocoa/40 focus:border-rose" placeholder="Instagram, YouTube, Spotify, or website" />
    //       </label>
    //       <label className="block sm:col-span-2">
    //         <span className="mb-2 block text-sm font-semibold text-cocoa">Short Bio</span>
    //         <textarea rows={6} className="w-full rounded-[24px] border border-cocoa/10 bg-white/70 px-4 py-3 outline-none placeholder:text-cocoa/40 focus:border-rose" placeholder="Tell us a little about your style and your sound" />
    //       </label>
    //       <div className="sm:col-span-2">
    //         <button type="button" className="pill-btn bg-rose text-white hover:bg-cocoa">Submit Artist Info</button>
    //       </div>
    //     </form>
    //   </FormCard>
    // </main>
