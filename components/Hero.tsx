        ...
        <div className="container-shell relative flex min-h-[88vh] items-center justify-center pt-28 pb-24 text-center sm:pt-36">
          <div className="max-w-3xl">
            ...
            <div className="text-5xl font-black leading-[0.95] text-butter drop-shadow-[0_6px_0_rgba(90,58,56,0.35)] sm:text-7xl lg:text-7xl pt-14">
              ...
              Showcase Venue */}
              {/* <Image src="/logo.png" alt="Absolutely HTX logo text" width={900} height={50} /> */}
              <Logo />
            </div>
            ...
            <div className="mt-9 flex flex-col items-center justify-center gap-4 sm:flex-row">
              ...
              <Link href="/upcoming-shows" className="px-3 py-2 rounded-full border border-black bg-black text-white  hover:bg-amber-800/50 hover:border-amber-800/50">
                See Upcoming Shows
              </Link>
